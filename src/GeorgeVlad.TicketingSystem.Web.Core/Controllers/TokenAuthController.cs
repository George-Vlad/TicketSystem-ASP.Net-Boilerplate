...
using Abp.UI;
using GeorgeVlad.TicketingSystem.Authentication.External;
...
namespace GeorgeVlad.TicketingSystem.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : TicketingSystemControllerBase
    {
