...
{
    public abstract class TicketingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TicketingSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TicketingSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TicketingSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TicketingSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TicketingSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TicketingSystemDbContext, Task<T>> func)
        {
            T result;
