...
using GeorgeVlad.TicketingSystem.Tests.DependencyInjection;
...
namespace GeorgeVlad.TicketingSystem.Tests
{
    ...
    public class TicketingSystemTestModule : AbpModule
    {
        public TicketingSystemTestModule(TicketingSystemEntityFrameworkModule abpProjectNameEntityFrameworkModule)
        {
